    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View>
                    <Imagem source={require("../../assets/images/F010.png")} title={""} number={"F010"} />
                    <Imagem source={require("../../assets/images/F011.png")} title={""} number={"F011"} />
                    <Imagem source={require("../../assets/images/F012.png")} title={""} number={"F012"} />
                </View>
