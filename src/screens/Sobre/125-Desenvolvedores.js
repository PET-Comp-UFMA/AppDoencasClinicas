    ...
    return(
            <SafeAreaView style = {styles.container}> 
                <ScrollView>
                    ...
                    <View>
                        <Imagem source={require("@images/F045.png")} title={"Ismael Moreira de Sousa"} number={"F007"}/>
                    ...
                    <View>
                        <Imagem source={require("@images/F044.png")} title={"Leilane Barbosa de Sousa"} number={"F007"}/>
