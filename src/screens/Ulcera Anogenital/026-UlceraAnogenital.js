    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={true}>
                ...
                <Imagem source={require("../../assets/images/F013.png")} title={"Acompanhamento"} number={"F013"}/>
                <Imagem source={require("../../assets/images/F014.png")} title={"Acompanhamento"} number={"F014"}/>
                <Imagem source={require("../../assets/images/F015.png")} title={"Acompanhamento"} number={"F015"}/>
