    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={true}>
                ...
                <Imagem source={require("../../assets/images/F016.png")} title={"Acompanhamento"} number={"F016"}/>
                <Imagem source={require("../../assets/images/F017.png")} title={"Acompanhamento"} number={"F017"}/>
                <Imagem source={require("../../assets/images/F018.png")} title={"Acompanhamento"} number={"F018"}/>
